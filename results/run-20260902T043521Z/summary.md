...
spend guard cap derivation:
  muse-glimmer-30b-8bit                          132 calls x 4096 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-02T04:35:21Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `4096`
...
- **concurrency**: `{"muse-glimmer-30b-8bit":1}`
- **providers**: `{"muse-glimmer-30b-8bit":"studio"}`
- **extra_body**: `{"muse-glimmer-30b-8bit":{"reasoning_effort":"none"}}`
...
## muse-glimmer-30b-8bit / hidden

### authored

- scored: 114, non_score: 0
- non_scores_by_reason: {}
- pass_at_1: 0.9210526315789473 (tasks_counted: 38)
- wall_clock: total 3434.1s, median/sample 24.9s, per_task_passed 92.8s
- pass_at_3: 0.9736842105263158 (tasks_counted: 38)
...
- wall_clock: total 585.7s, median/sample 35.9s, per_task_passed 97.6s
