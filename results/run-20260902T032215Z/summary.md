...
spend guard cap derivation:
  nemotron-3-super-low                           132 calls x 4096 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-02T03:22:15Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `4096`
...
- **concurrency**: `{"nemotron-3-super-low":1}`
- **providers**: `{"nemotron-3-super-low":"studio"}`
- **extra_body**: `{"nemotron-3-super-low":{"reasoning_effort":"low"}}`
...
## nemotron-3-super-low / hidden

### authored

- scored: 105, non_score: 9
- non_scores_by_reason: {truncated: 9}
- pass_at_1: 0.9099099099099098 (tasks_counted: 37)
- wall_clock: total 3177.8s, median/sample 19.1s, per_task_passed 93.5s
- pass_at_3: 0.9411764705882353 (tasks_counted: 34)
...
| delegating_proxy_method_object | 1 | 0 | {truncated: 2} |
| delivery_audited_route_block | 3 | 3 | {} |
| distance_coerce_subtraction | 1 | 1 | {truncated: 2} |
...
| ledger_freeze_dup_clone | 0 | 0 | {truncated: 3} |
...
- wall_clock: total 512.5s, median/sample 28.8s, per_task_passed 85.4s
