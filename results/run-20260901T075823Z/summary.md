...
- **schema_version**: `3`
- **generated_at**: `2026-09-01T07:58:23Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `16384`
...
- **concurrency**: `{"qwen3.8-27b-mxfp8-concurrent1":1}`
- **providers**: `{"qwen3.8-27b-mxfp8-concurrent1":"studio"}`
- **extra_body**: `{"qwen3.8-27b-mxfp8-concurrent1":{"reasoning_effort":"none"}}`
...
- wall_clock: total 1067.3s, median/sample 7.3s, per_task_passed 32.3s
...
- wall_clock: total 150.0s, median/sample 8.1s, per_task_passed 25.0s
