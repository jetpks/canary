...
actual spend (from recorded token usage x price table): $1.4828

spend guard cap derivation:
  qwen/qwen3.6-27b                               102 calls x 16384 x $0.00000320 = $5.3477
  worst case sum: $5.3477
  cap (3x worst case, rounded up): $17

## qwen/qwen3.6-27b / hidden

### authored

- scored: 83, non_score: 1
- non_scores_by_reason: {truncated: 1}
- pass_at_1: 0.869047619047619 (tasks_counted: 28)
