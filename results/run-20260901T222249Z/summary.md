...
spend guard cap derivation:
  gemma-4-e4b                                    132 calls x 16384 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-01T22:22:49Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `16384`
...
- **concurrency**: `{"gemma-4-e4b":1}`
- **providers**: `{"gemma-4-e4b":"studio"}`
- **extra_body**: `{"gemma-4-e4b":{"reasoning_effort":"none"}}`
...
- scored: 112, non_score: 2
- non_scores_by_reason: {premature_stop: 2}
- pass_at_1: 0.47807017543859653 (tasks_counted: 38)
- wall_clock: total 646.9s, median/sample 4.1s, per_task_passed 24.9s
- pass_at_3: 0.6944444444444444 (tasks_counted: 36)
...
| delegating_proxy_method_object | 3 | 1 | {} |
...
| metaprogramming_open_record | 2 | 1 | {premature_stop: 1} |
...
| shadowed_constant_circle | 3 | 2 | {} |
| shipment_alert_recipient_protocol | 3 | 1 | {} |
...
- pass_at_1: 0.8333333333333334 (tasks_counted: 6)
- wall_clock: total 102.2s, median/sample 3.0s, per_task_passed 17.0s
- pass_at_3: 1.0 (tasks_counted: 5)

| task | scored | passed | non_score_reasons |
|---|---|---|---|
| attribute_bag_hash_equality | 3 | 2 | {} |
| cache_sweep_packed_entries | 2 | 2 | {premature_stop: 1} |
| counter_override_dup_clone | 3 | 2 | {} |
| gauge_reading_exact_sum | 3 | 3 | {} |
| stock_count_float_difference | 3 | 2 | {} |
