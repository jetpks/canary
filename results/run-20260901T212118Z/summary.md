...
spend guard cap derivation:
  qwen3-122b-a10b                                132 calls x 16384 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-01T21:21:18Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `16384`
...
- **concurrency**: `{"qwen3-122b-a10b":1}`
- **providers**: `{"qwen3-122b-a10b":"studio"}`
- **extra_body**: `{"qwen3-122b-a10b":{"reasoning_effort":"none"}}`
...
- pass_at_1: 0.7456140350877193 (tasks_counted: 38)
- wall_clock: total 439.6s, median/sample 2.6s, per_task_passed 13.7s
- pass_at_3: 0.8648648648648649 (tasks_counted: 37)
...
- wall_clock: total 67.7s, median/sample 3.0s, per_task_passed 11.3s
