...
spend guard cap derivation:
  nemotron-3-nano-30b-a3b                        132 calls x 4096 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-02T01:13:35Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `4096`
...
- **concurrency**: `{"nemotron-3-nano-30b-a3b":1}`
- **providers**: `{"nemotron-3-nano-30b-a3b":"studio"}`
- **extra_body**: `{"nemotron-3-nano-30b-a3b":{"reasoning_effort":"none"}}`
...
## nemotron-3-nano-30b-a3b / hidden

### authored

- scored: 113, non_score: 1
- non_scores_by_reason: {premature_stop: 1}
- pass_at_1: 0.41228070175438597 (tasks_counted: 38)
- wall_clock: total 133.2s, median/sample 1.0s, per_task_passed 6.3s
- pass_at_3: 0.5405405405405406 (tasks_counted: 37)
...
| ensure_return_swallows_exception | 2 | 2 | {premature_stop: 1} |
...
- pass_at_1: 0.6111111111111112 (tasks_counted: 6)
- wall_clock: total 24.2s, median/sample 0.9s, per_task_passed 4.0s
- pass_at_3: 1.0 (tasks_counted: 6)

| task | scored | passed | non_score_reasons |
|---|---|---|---|
| attribute_bag_hash_equality | 3 | 2 | {} |
| cache_sweep_packed_entries | 3 | 1 | {} |
