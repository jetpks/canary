...
spend guard cap derivation:
  muse-glimmer-30b-4bit                          132 calls x 4096 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-02T05:42:22Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `4096`
...
- **concurrency**: `{"muse-glimmer-30b-4bit":1}`
- **providers**: `{"muse-glimmer-30b-4bit":"studio"}`
- **extra_body**: `{"muse-glimmer-30b-4bit":{"reasoning_effort":"none"}}`
...
## muse-glimmer-30b-4bit / hidden

### authored

- scored: 114, non_score: 0
- non_scores_by_reason: {}
- pass_at_1: 0.8508771929824562 (tasks_counted: 38)
- wall_clock: total 2121.8s, median/sample 14.1s, per_task_passed 58.9s
- pass_at_3: 0.9473684210526315 (tasks_counted: 38)
...
| playlist_dup_clone_singleton | 3 | 1 | {} |
...
- wall_clock: total 299.1s, median/sample 16.2s, per_task_passed 49.9s
