...
actual spend (from recorded token usage x price table): $0.2114

spend guard cap derivation:
  qwen/qwen3.5-122b-a10b                         102 calls x 16384 x $0.00000208 = $3.4760
  worst case sum: $3.4760
  cap (3x worst case, rounded up): $11

## qwen/qwen3.5-122b-a10b / hidden

### authored

- scored: 84, non_score: 0
- non_scores_by_reason: {}
- pass_at_1: 0.8214285714285714 (tasks_counted: 28)
- pass_at_3: 0.8928571428571429 (tasks_counted: 28)
