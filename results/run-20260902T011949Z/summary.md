...
spend guard cap derivation:
  gemma-4-26b-a4b                                132 calls x 4096 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-02T01:19:49Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `4096`
...
- **concurrency**: `{"gemma-4-26b-a4b":1}`
- **providers**: `{"gemma-4-26b-a4b":"studio"}`
- **extra_body**: `{"gemma-4-26b-a4b":{"reasoning_effort":"none"}}`
...
## gemma-4-26b-a4b / hidden

### authored

- scored: 114, non_score: 0
- non_scores_by_reason: {}
- pass_at_1: 0.8157894736842105 (tasks_counted: 38)
- wall_clock: total 435.5s, median/sample 1.8s, per_task_passed 12.8s
...
- wall_clock: total 76.4s, median/sample 2.4s, per_task_passed 15.3s
