...
- **schema_version**: `3`
- **generated_at**: `2026-09-01T08:22:23Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `16384`
...
- **extra_body**: `{"qwen3.6-35b-a3b-8bit":{}}`
...
- pass_at_1: 0.7280701754385965 (tasks_counted: 38)
- wall_clock: total 250.3s, median/sample 1.6s, per_task_passed 7.4s
...
- wall_clock: total 34.5s, median/sample 1.8s, per_task_passed 5.7s
