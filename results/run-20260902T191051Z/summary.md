...
spend guard cap derivation:
  nemotron-3-super-low                           132 calls x 16384 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-02T19:10:51Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `16384`
...
- pass_at_1: 0.9035087719298246 (tasks_counted: 38)
- wall_clock: total 4143.0s, median/sample 18.8s, per_task_passed 118.4s
- pass_at_3: 0.9459459459459459 (tasks_counted: 37)
...
| delegating_proxy_method_object | 2 | 0 | {truncated: 1} |
...
- wall_clock: total 505.0s, median/sample 28.5s, per_task_passed 84.2s
