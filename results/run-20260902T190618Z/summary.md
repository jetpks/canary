...
spend guard cap derivation:
  qwen3.6-35b-a3b-8bit                           132 calls x 4096 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-02T19:06:18Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `4096`
...
- **concurrency**: `{"qwen3.6-35b-a3b-8bit":1}`
- **providers**: `{"qwen3.6-35b-a3b-8bit":"studio"}`
- **extra_body**: `{"qwen3.6-35b-a3b-8bit":{"reasoning_effort":"none"}}`
...
- wall_clock: total 207.4s, median/sample 1.4s, per_task_passed 6.1s
...
- wall_clock: total 39.9s, median/sample 1.5s, per_task_passed 6.6s
