...
spend guard cap derivation:
  muse-glimmer-30b-mxfp4                         132 calls x 4096 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-02T02:14:34Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `4096`
...
- **concurrency**: `{"muse-glimmer-30b-mxfp4":1}`
- **providers**: `{"muse-glimmer-30b-mxfp4":"studio"}`
- **extra_body**: `{"muse-glimmer-30b-mxfp4":{"reasoning_effort":"none"}}`
...
## muse-glimmer-30b-mxfp4 / hidden

### authored

- scored: 114, non_score: 0
- non_scores_by_reason: {}
- pass_at_1: 0.8947368421052632 (tasks_counted: 38)
- wall_clock: total 2174.4s, median/sample 13.4s, per_task_passed 57.2s
- pass_at_3: 1.0 (tasks_counted: 38)
...
- wall_clock: total 305.5s, median/sample 15.1s, per_task_passed 50.9s
