...
spend guard cap derivation:
  devstral-small-2-24b                           132 calls x 4096 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-02T00:53:00Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `4096`
...
- **concurrency**: `{"devstral-small-2-24b":1}`
- **providers**: `{"devstral-small-2-24b":"studio"}`
- **extra_body**: `{"devstral-small-2-24b":{}}`
...
## devstral-small-2-24b / hidden

### authored

- scored: 114, non_score: 0
- non_scores_by_reason: {}
- pass_at_1: 0.6403508771929824 (tasks_counted: 38)
- wall_clock: total 806.7s, median/sample 5.5s, per_task_passed 26.9s
- pass_at_3: 0.7894736842105263 (tasks_counted: 38)
...
- wall_clock: total 121.7s, median/sample 7.2s, per_task_passed 20.3s
