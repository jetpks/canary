...
spend guard cap derivation:
  qwen3.8-flash-next-reap288                     132 calls x 16384 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-01T06:17:02Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `16384`
...
- **concurrency**: `{"qwen3.8-flash-next-reap288":1}`
- **providers**: `{"qwen3.8-flash-next-reap288":"studio"}`
- **extra_body**: `{"qwen3.8-flash-next-reap288":{"reasoning_effort":"none"}}`
...
## qwen3.8-flash-next-reap288 / hidden

### authored

- scored: 112, non_score: 2
- non_scores_by_reason: {extractor_refusal: 2}
- pass_at_1: 0.5263157894736842 (tasks_counted: 38)
- wall_clock: total 5693.2s, median/sample 5.6s, per_task_passed 189.8s
- pass_at_3: 0.8333333333333334 (tasks_counted: 36)
...
| reading_circle_member_enumeration | 3 | 1 | {} |
...
| struct_vector | 3 | 3 | {} |
| tallying_key_store_fetch_contract | 3 | 2 | {} |
| temperature_report_injected_scale | 2 | 0 | {extractor_refusal: 1} |
| to_proc_lookup | 3 | 0 | {} |
| weight_unit_partial_order | 3 | 2 | {} |
...
- wall_clock: total 380.2s, median/sample 6.4s, per_task_passed 63.4s
