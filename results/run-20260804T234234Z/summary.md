...
actual spend (from recorded token usage x price table): $0.0196

spend guard cap derivation:
  google/gemma-4-26b-a4b-it                      102 calls x 16384 x $0.00000040 = $0.6685
  worst case sum: $0.6685
  cap (3x worst case, rounded up): $3

## google/gemma-4-26b-a4b-it / hidden

### authored

- scored: 84, non_score: 0
- non_scores_by_reason: {}
- pass_at_1: 0.75 (tasks_counted: 28)
