...
spend guard cap derivation:
  qwen3.8-27b-mxfp8-plain                        132 calls x 4096 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-02T03:03:13Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `4096`
...
- **concurrency**: `{"qwen3.8-27b-mxfp8-plain":1}`
- **providers**: `{"qwen3.8-27b-mxfp8-plain":"studio"}`
- **extra_body**: `{"qwen3.8-27b-mxfp8-plain":{"reasoning_effort":"none"}}`
...
## qwen3.8-27b-mxfp8-plain / hidden

### authored

- scored: 114, non_score: 0
- non_scores_by_reason: {}
- pass_at_1: 0.7368421052631579 (tasks_counted: 38)
- wall_clock: total 986.3s, median/sample 7.1s, per_task_passed 29.9s
- pass_at_3: 0.868421052631579 (tasks_counted: 38)

| task | scored | passed | non_score_reasons |
|---|---|---|---|
| block_memoizer | 3 | 3 | {} |
| block_safe_caller | 3 | 3 | {} |
| case_match_temperature_band | 3 | 1 | {} |
...
- wall_clock: total 142.0s, median/sample 7.3s, per_task_passed 23.7s
