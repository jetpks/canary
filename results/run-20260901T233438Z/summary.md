...
spend guard cap derivation:
  muse-glimmer-30b                               132 calls x 4096 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-01T23:34:38Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `4096`
...
- **concurrency**: `{"muse-glimmer-30b":1}`
- **providers**: `{"muse-glimmer-30b":"studio"}`
- **extra_body**: `{"muse-glimmer-30b":{"reasoning_effort":"none"}}`
...
- wall_clock: total 3974.7s, median/sample 28.0s, per_task_passed 110.4s
...
- wall_clock: total 561.3s, median/sample 33.3s, per_task_passed 93.6s
