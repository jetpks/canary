...
- **schema_version**: `3`
- **generated_at**: `2026-09-01T05:49:34Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `16384`
...
- **concurrency**: `{"qwen3.8-flash-next-oq3":1}`
- **providers**: `{"qwen3.8-flash-next-oq3":"studio"}`
- **extra_body**: `{"qwen3.8-flash-next-oq3":{"reasoning_effort":"none"}}`
...
- pass_at_1: 0.7763157894736842 (tasks_counted: 38)
- wall_clock: total 1215.9s, median/sample 5.2s, per_task_passed 34.7s
- pass_at_3: 0.9166666666666666 (tasks_counted: 36)
...
| eql_hash_distance_point | 2 | 1 | {extractor_refusal: 1} |
...
- wall_clock: total 140.3s, median/sample 5.1s, per_task_passed 23.4s
