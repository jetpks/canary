...
spend guard cap derivation:
  gemma-4-31b                                    132 calls x 4096 x $0.00000000 = $0.0000
...
- **schema_version**: `3`
- **generated_at**: `2026-09-02T01:28:22Z`
- **tasks**: `44`
- **hidden_k**: `3`
- **visible_k**: `1`
- **max_tokens**: `4096`
...
- **concurrency**: `{"gemma-4-31b":1}`
- **providers**: `{"gemma-4-31b":"studio"}`
- **extra_body**: `{"gemma-4-31b":{"reasoning_effort":"none"}}`
...
- wall_clock: total 1755.4s, median/sample 10.2s, per_task_passed 51.6s
...
- wall_clock: total 212.2s, median/sample 10.3s, per_task_passed 35.4s
